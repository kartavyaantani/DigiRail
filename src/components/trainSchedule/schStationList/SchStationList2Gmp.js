...
import SchGmpToKdyAdd from '../schGmp/SchGmpToKdyAdd';
import SchGmpToKdyTable from '../schGmp/SchGmpToKdyTable';
...
export default function SchStationList2Gmp() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tab label="Colombo Fort" {...a11yProps(4)} />
        <Tab label="Gampaha" {...a11yProps(5)} disabled />
